    ...
    <footer id="contact" className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">The Humble Hackers</h3>
            <p className="text-gray-400 mb-4">
              Creating beautiful landing pages for businesses of all sizes.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">info@yourbrand.com</p>
            <p className="text-gray-400">(123) 456-7890</p>
          </div>
        </div>
        
        <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2025 The Humble Hackers. All rights reserved.</p>
